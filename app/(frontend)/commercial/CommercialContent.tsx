...
export default function CommercialContent({ data }: { data: CommercialPageData }) {
  const [formData, setFormData] = useState({
    name: '', email: '', projectType: '', phone: '', location: '', details: ''
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
          ...
          <div className="group relative aspect-[4/5] overflow-hidden bg-[#0B0B0B]">
            <Image 
                ...
                unoptimized
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent group-hover:from-black group-hover:via-black/90 group-hover:to-black/40 transition-all duration-700 flex flex-col justify-end p-10">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] uppercase font-bold tracking-widest text-[#0B0B0B]/40">טלפון</label>
                <input 
                  required
                  className={inputClasses} 
