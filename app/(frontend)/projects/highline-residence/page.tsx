      ...
      <main className="pt-24">
        ...
        <section className="pb-32">
          <div className="mx-auto max-w-[1800px] px-8">
            ...
            <Link href="/projects/nouveau-penthouse" className="bg-black text-white py-32 overflow-hidden relative group cursor-pointer block">
              <div className="absolute inset-0 opacity-20 grayscale transition-transform duration-1000 group-hover:scale-105" style={{ backgroundImage: "url('/assets/images/img_38ac2d605600.webp')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
              <div className="mx-auto max-w-[1440px] px-8 relative z-10 flex flex-col items-center">
                ...
                <h2 className="font-serif text-5xl md:text-8xl italic text-center transition-transform duration-500 group-hover:-translate-y-2">Nouveau Penthouse</h2>
