    ...
    <div className="min-h-screen bg-[#f7f7f7] text-right" dir="rtl">
      ...
      <main className="pt-24">
        <section className="relative h-[80vh] w-full overflow-hidden bg-black">
          <div className="absolute inset-0 bg-cover bg-center grayscale brightness-75 transition-transform duration-1000 scale-105" style={{ backgroundImage: "url('/assets/images/img_c4c407d8b8f7.webp')" }}></div>
          <div className="relative z-10 flex h-full items-center justify-center">
            <h1 className="font-serif text-7xl md:text-[8rem] text-white/90 text-center leading-none">
              The Monolith <br/> <span className="italic">Hotel</span>
            </h1>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
            <div className="md:col-span-8 text-right">
              ...
              <p className="mt-16 text-lg font-light leading-relaxed text-black/60 max-w-xl">
                מלון בוטיק בלב מילאנו, מגורים אלו משמשים כמקלט של מינרלים ואור. כל משטח נבחר בקפידה כדי להבטיח המשכיות קצבית בין חללי המגורים לסביבות האירוח האינטימיות. התוצאה היא נרטיב אדריכלי חלק של יוקרה ואיפוק.
              </p>
            </div>
            <div className="md:col-span-4 space-y-10 pt-4 text-right">
              ...
              <div>
                ...
                <p className="text-sm font-medium">מילאנו, איטליה</p>
              </div>
              <div className="h-px bg-black/10"></div>
              <div>
        ...
        <section className="pb-32">
          <div className="mx-auto max-w-[1800px] px-8">
            ...
            <Link href="/projects/carrara-showroom" className="bg-black text-white py-32 overflow-hidden relative group cursor-pointer block">
              <div className="absolute inset-0 opacity-20 grayscale transition-transform duration-1000 group-hover:scale-105" style={{ backgroundImage: "url('/assets/images/img_69be383dc846.webp')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
              <div className="mx-auto max-w-[1440px] px-8 relative z-10 flex flex-col items-center">
                ...
                <h2 className="font-serif text-5xl md:text-8xl italic text-center transition-transform duration-500 group-hover:-translate-y-2">Carrara Showroom</h2>
