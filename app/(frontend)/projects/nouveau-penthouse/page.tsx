    ...
    <div className="min-h-screen bg-[#f7f7f7] text-right" dir="rtl">
      ...
      <main className="pt-24">
        <section className="relative h-[80vh] w-full overflow-hidden bg-black">
          <div className="absolute inset-0 bg-cover bg-center grayscale brightness-75 transition-transform duration-1000 scale-105" style={{ backgroundImage: "url('/assets/images/img_38ac2d605600.webp')" }}></div>
          <div className="relative z-10 flex h-full items-center justify-center">
            <h1 className="font-serif text-7xl md:text-[8rem] text-white/90 text-center leading-none">
              Nouveau <br/> <span className="italic">Penthouse</span>
            </h1>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
            <div className="md:col-span-8 text-right">
              ...
              <p className="mt-16 text-lg font-light leading-relaxed text-black/60 max-w-xl">
                גבוה מעל קו הרקיע, מגורים אלו משמשים כמקלט של מינרלים ואור. כל משטח נבחר בקפידה ממחצבות קרארה כדי להבטיח המשכיות קצבית בין חללי המגורים לסביבות האמבט האינטימיות. התוצאה היא נרטיב אדריכלי חלק של יוקרה ואיפוק.
              </p>
            </div>
            <div className="md:col-span-4 space-y-10 pt-4 text-right">
              ...
              <div>
                ...
                <p className="text-sm font-medium">טרייבקה, ניו יורק</p>
              </div>
              <div className="h-px bg-black/10"></div>
              <div>
        ...
        <section className="pb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center mb-40">
            ...
            <Link href="/projects/azure-coastal-villa" className="bg-black text-white py-32 overflow-hidden relative group cursor-pointer block">
